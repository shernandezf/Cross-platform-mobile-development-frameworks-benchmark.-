...
if opciones.language.lower()=="kotlin":
    averageK=run_kotlin()
    print("Kotlin average runtime for the prime number with Sieve of Eratosthenes algorithm calculation problem ",averageK ,"milliseconds")
elif opciones.language.lower()=="javascript":
    averageJ=run_javaScript()
    print("JavaScript average runtime for the prime number with Sieve of Eratosthenes algorithm calculation problem " ,averageJ ,"milliseconds")

elif opciones.language.lower()=="dart":
    averageD=run_dart()
    print("Dart average runtime for the prime number with Sieve of Eratosthenes algorithm calculation problem " ,averageD ,"milliseconds")
